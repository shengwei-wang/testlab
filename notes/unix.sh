...
# Unix Time stamp tutoril: http://www.unixtutorial.org/2008/04/atime-ctime-mtime-in-unix-filesystems/
...
/usr/sfw/bin/wget "http://nexus.test.com/service/local/artifact/maven/content?r=Snapshots&g=groupid&a=pbadmin2&v=LATEST&p=war" -nv --content-disposition --user=user --password=password -O foo.war

/usr/sfw/bin/wget "http://nexus.test.com/service/local/artifact/maven/resolve?r=Releases&g=groupid&a=pbadmin2&v=LATEST&p=war" --user=user --password=password -O foo.txt
